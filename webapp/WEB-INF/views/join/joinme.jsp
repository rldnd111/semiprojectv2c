                ...
                <div class="card card-body bg-light">
                    ...
                    <div class="row">
                        <div class="col-11 offset-1">
                            ...
                            <label class="col-2 col-form-label
                                    ...
                                    <input type="text" name="name" id="name"
                                           class="border-danger form-control col-2" readonly>
                        </div><!-- 이름 -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-2 col-form-label
                                              text-danger text-right"for="email1">전장편 주소</label>
                                ...
                                &nbsp;&nbsp;
                                <select class="form-control border-danger col-2"><option>- 선택하세요- </option>
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" name="dong" id="dong"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select class="col-8 offset-2 form-control" size="10" accesskey="addrlist" name="addrlist">

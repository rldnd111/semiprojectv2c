                    ...
                    <div class="row">
                        <table class="table col-10 offset-1">
                            ...
                            <tr class="tbbg3"><td colspan="2">
                                ...
                                <div><img src="/img/cat2.jpg" class="img-fluid"></div>
                                <div><img src="/img/cat3.jpg" class="img-fluid"></div>
                                </td></tr><!-- 본문 -->
                                <tr><td colspan="2" class="tbbg4">
                                    <i class="fas fa-file-image"></i><img src=""> homework.jpg (123KB)</td></tr>
                            <tr><td colspan="2" class="tbbg4">
                                    <i class="fas fa-file-image"></i><img src=""> homework.gif (456KB)</td></tr>
                            <tr><td colspan="2" class="tbbg4">
                                    <i class="fas fa-file-image"></i><img src=""> homework.png (789KB)</td></tr>
                        </table>
                    </div>
